...
export const GLOSSARY: Record<string, string> = {
  ...
  USG_PCT:
    "Usage rate — share of team possessions this player finishes with a shot, free throws or turnover while on the floor.",
  AST_TO: "Assist-to-turnover ratio — assists divided by turnovers. Higher is better.",
  AST_PCT: "Assist % — share of teammate baskets this player assisted while on the floor.",
  ...
  PERCENTILE:
    "Percentile vs same position — e.g. 84th percentile means better than 84% of players at this position (min. 10 games, 15 MPG).",
  ON_OFF:
  ...
  FG3A_RATE: "3-point attempt rate — share of field-goal attempts taken from three.",
  POSS: "Possessions — team possessions while the player was on the floor.",
  CLUTCH: "Clutch — last 5 minutes of a game with the score within 5 points.",
  FOUR_FACTORS:

...
import { Card, CardTitle, ErrorState, GlossaryTip, Skeleton } from "../components/ui";
  ...
  return (
    <div className="space-y-4">
      ...
      {!a || !b ? (
        ...
        <div className="space-y-3"><Skeleton className="h-64 rounded-xl" /><Skeleton className="h-64 rounded-xl" /></div>
      ) : error ? (
